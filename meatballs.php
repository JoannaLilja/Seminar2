...
<body>
				...
				<div id="navWrap">
					<div id="nav">
						<ul>
							...
							<li><a href="meatballs.php" style = "color: rgb(250,0,0)">Meatballs Recipe</a></li>
	...
	$result = $dbcon->query('SELECT * FROM comments JOIN credentials ON comments.user_id = credentials.id WHERE type=1');
